/*
  ...
  - You are about to drop the column `deadline` on the `Appointement` table. All the data in the column will be lost.
...
INSERT INTO "new_Appointement" ("category_id", "description", "doctor_id", "id", "price", "status", "title", "user_id") SELECT "category_id", "description", "doctor_id", "id", "price", "status", "title", "user_id" FROM "Appointement";
